...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/ramsend-relay.cpp \
           src/ramsend.cpp \
           src/braincoin-cli.cpp \
           src/braincoin-tx.cpp \
           src/braincoind.cpp \
           src/db.cpp \
           ...
           src/qt/ramsendconfig.cpp \
           src/qt/braincoin.cpp \
           src/qt/braincoinstrings.cpp \
...
RESOURCES += src/qt/braincoin.qrc src/qt/braincoin_locale.qrc
TRANSLATIONS += src/qt/locale/braincoin_bg.ts \
                src/qt/locale/braincoin_de.ts \
                src/qt/locale/braincoin_en.ts \
                src/qt/locale/braincoin_es.ts \
                src/qt/locale/braincoin_fi.ts \
                src/qt/locale/braincoin_fr.ts \
                src/qt/locale/braincoin_it.ts \
                src/qt/locale/braincoin_ja.ts \
                src/qt/locale/braincoin_pl.ts \
                src/qt/locale/braincoin_pt.ts \
                src/qt/locale/braincoin_ru.ts \
                src/qt/locale/braincoin_sk.ts \
                src/qt/locale/braincoin_sv.ts \
                src/qt/locale/braincoin_vi.ts \
                src/qt/locale/braincoin_zh_CN.ts \
                src/qt/locale/braincoin_zh_TW.ts
