...
RESOURCES += src/qt/ic.qrc src/qt/ic_locale.qrc
TRANSLATIONS += src/qt/locale/ic_bg.ts \
                src/qt/locale/ic_de.ts \
                src/qt/locale/ic_en.ts \
                src/qt/locale/ic_es.ts \
                src/qt/locale/ic_fi.ts \
                src/qt/locale/ic_fr.ts \
                src/qt/locale/ic_it.ts \
                src/qt/locale/ic_ja.ts \
                src/qt/locale/ic_pl.ts \
                src/qt/locale/ic_pt.ts \
                src/qt/locale/ic_ru.ts \
                src/qt/locale/ic_sk.ts \
                src/qt/locale/ic_sv.ts \
                src/qt/locale/ic_vi.ts \
                src/qt/locale/ic_zh_CN.ts \
                src/qt/locale/ic_zh_TW.ts
