...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Braincoin Core braincoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  braincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded braincoin transaction") + "\n" +
              "  braincoin-tx [options] -create [commands]   " + _("Create hex-encoded braincoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded braincoin transaction
