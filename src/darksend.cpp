...
/* *** BEGIN DARKSEND MAGIC - IC **********
    Copyright (c) 2014-2015, Ic Developers
        eduffield - evan@icclassic.io
        udjinm6   - udjinm6@icclassic.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Ic and make it unusable. To
