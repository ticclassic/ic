...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Braincoin Core"),
     ...
     * override -datadir in the braincoin.conf file in the default data directory
     * (to be consistent with braincoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
