    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ic Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Ic Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ic Core is shutting down...") + "<br /><br />" +
