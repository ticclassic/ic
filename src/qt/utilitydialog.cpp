    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Brain Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Brain Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  brain-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Brain Core is shutting down...") + "<br /><br />" +
