    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Braincoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Braincoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  braincoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Braincoin Core is shutting down...") + "<br /><br />" +
