    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Putic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Putic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and putic: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Putic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Putic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Putic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Putic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Putic addresses"));
    ...
    openAction->setStatusTip(tr("Open a putic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Putic Core help message to get a list with possible Putic command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Putic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Putic network", "", count));
}
...
{
    QString strTitle = tr("Putic Core"); // default title
