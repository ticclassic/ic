    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ic: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ic addresses"));
    ...
    openAction->setStatusTip(tr("Open a ic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ic Core help message to get a list with possible Ic command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ic network", "", count));
}
...
{
    QString strTitle = tr("Ic Core"); // default title
