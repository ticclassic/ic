    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Brain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Brain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and brain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Brain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Brain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Brain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Brain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Brain addresses"));
    ...
    openAction->setStatusTip(tr("Open a brain: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Brain Core help message to get a list with possible Brain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Brain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Brain network", "", count));
}
...
{
    QString strTitle = tr("Brain Core"); // default title
