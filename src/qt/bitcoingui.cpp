    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Braincoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Braincoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and braincoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Braincoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Braincoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Braincoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Braincoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Braincoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a braincoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Braincoin Core help message to get a list with possible Braincoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Braincoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Braincoin network", "", count));
}
...
{
    QString strTitle = tr("Braincoin Core"); // default title
