...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(BitcoinUnits::BRAINCOIN)
    {
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("BRAINCOIN")
    updateDisplayUnit();
}
...
void OverviewPage::updateRamsendProgress()
{
    ...
    if(currentBalance == 0)
    {
        ...
        strAmountAndRounds = strAnonymizeDarkcoinAmount + " / " + tr("%n Rounds", "", nRamsendRounds);
