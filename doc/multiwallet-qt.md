...
Only requiring some minor changes is brain.cpp.
...
Changes to brain.cpp
----------------------
brain.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
