...
Only requiring some minor changes is putic.cpp.
...
Changes to putic.cpp
----------------------
putic.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
