...
Only requiring some minor changes is braincoin.cpp.
...
Changes to braincoin.cpp
----------------------
braincoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
