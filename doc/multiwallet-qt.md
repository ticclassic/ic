...
Only requiring some minor changes is ic.cpp.
...
Changes to ic.cpp
----------------------
ic.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
